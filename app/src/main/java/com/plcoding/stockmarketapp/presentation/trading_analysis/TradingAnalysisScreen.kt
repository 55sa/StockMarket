...
//            MyRowChart(title = "Trading Transaction", data = state.transactionAmountDistribution)
//
//        }
//        if (state.showUserActivePeriods) {
////            Text("User Active Periods")
//            MyColumnChart(title = "Active Periods", data = state.userActivePeriods)
//
//        }
...
//            MyRowChart(title = "Profit Loss Distribution", data = state.profitLossDistribution)
//
//        }
//    }
//}
